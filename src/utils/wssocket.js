...
let heartCheck = {
  ...
  start: function () {
    if (isConnect) {
      ...
      receiveHeartCallBack && receiveHeartCallBack(true);
      console.log("发送WebSocket心跳----------------------");
    }
  },
...
let sendHeart = (callback) => {
  console.log("898981----------------------22222222222");
  receiveHeartCallBack = callback;
};
// 将方法暴露出去
export {
  connect,
